...
public class DropdownFilterPivotPage extends BasePage {
    ...
    //кнопка открытия дропдауна фильтрации
    ...
    //Проверяем что есть все чекбоксы
    ...
    //Проверяем что есть все радиокнопки
    ...
    //Проверяем что есть дропдаун филиал
    ...
    //проверяем наличие кнопок применить и отменить
    ...
    //Проверяем список выбранных по умолчанию радиокнопок
